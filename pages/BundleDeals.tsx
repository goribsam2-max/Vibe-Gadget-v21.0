                            ...
                            <div className="flex gap-6 items-center">
                                ...
                                <div className="flex-1">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className="text-xl md:text-2xl font-black text-[#ea580c]">৳{Math.floor(product.isOffer && product.offerPrice ? product.offerPrice : (product.price * 0.9))}</span>
                                        <span className="text-sm font-semibold text-zinc-400 line-through">৳{product.price}</span>
                                    </div>
                                </div>
                            </div>
